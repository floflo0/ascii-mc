...
#define ARGS_FLAGS                                                           \
    ...
    FLAG_WITH_PARAM(players, "players", p, PLAYERS,                          \
                    "the number of players to create (default: 1)")          \
    FLAG_WITH_PARAM(world_seed, "world-seed", s, SEED,                       \
                    "the seed used to generate the world (default: random)") \
