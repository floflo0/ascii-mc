...
#define PLAYER_DEFAULT_GAME_MODE PLAYER_GAME_MODE_SURVIVAL
...
#define MESH_SHADOW_DISTANCE (CHUNK_SIZE * WORLD_RENDER_DISTANCE * 0.96f)
#define MESH_SHADOW_COLOR COLOR_DARK_GREY

#define GAMEPAD_ARRAY_DEFAULT_CAPACITY 4
#define GAMEPAD_AXIS_ROUND 0.01f
#define GAMEPAD_RUMBLE_EFFECT_LOW_FREQUENCY 0xffff
#define GAMEPAD_RUMBLE_EFFECT_HIGH_FREQUENCY 0xffff
#define GAMEPAD_RUMBLE_EFFECT_DURATION 500  // ms
#define GAMEPAD_RUMBLE_ONE_CONNECTION
...
#ifdef __wasm__
#warm "GAME_MAX_FRAMERATE has no effect in the wasm version"
#endif
...
STATIC_ASSERT_IS_INTEGER(GAMEPAD_ARRAY_DEFAULT_CAPACITY);
static_assert(0 < GAMEPAD_ARRAY_DEFAULT_CAPACITY);
static_assert(0.0f <= GAMEPAD_AXIS_ROUND);
static_assert(0 <= GAMEPAD_RUMBLE_EFFECT_LOW_FREQUENCY &&
              GAMEPAD_RUMBLE_EFFECT_LOW_FREQUENCY <= 0xffff);
static_assert(0 <= GAMEPAD_RUMBLE_EFFECT_HIGH_FREQUENCY &&
              GAMEPAD_RUMBLE_EFFECT_HIGH_FREQUENCY <= 0xffff);
STATIC_ASSERT_IS_INTEGER(GAMEPAD_RUMBLE_EFFECT_DURATION);
static_assert(0 < GAMEPAD_RUMBLE_EFFECT_DURATION);
